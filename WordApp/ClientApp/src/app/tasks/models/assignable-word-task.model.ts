...
export class AssignableWordTaskModel {
  ...
  constructor(wordTask: WordTaskModel, user: UserModel, taskStatus : Enums.ETaskStatus, deadline: Date, answers: Array<AnsweredWordModel>, id: string, rowVersion: string) {
